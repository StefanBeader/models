                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col form-group">
                                    ...
                                    <input value="{{ $mannequin->first_name }}" id="first_name" name="first_name" type="text" class="form-control">
                                    @error('first_name')
                                ...
                                <div class="col form-group">
                                    ...
                                    <input value="{{ $mannequin->last_name }}" id="last_name" name="last_name" type="text" class="form-control">
                                    @error('last_name')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="form-group">
                                ...
                                <input value="{{ $mannequin->email }}" id="email" name="email" type="email" class="form-control">
                                @error('email')
                                <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="row">
                                <div class="col form-group">
                                    ...
                                    <input value="{{ $mannequin->phone }}" id="phone" name="phone" type="text" class="form-control">
                                    @error('phone')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                ...
                                <div class="col form-group">
                                    ...
                                    <input value="{{ $mannequin->city }}" id="city" name="city" type="text" class="form-control">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="instagram">Instagram</label>
                                <input value="{{ $mannequin->instagram }}" id="instagram" name="instagram" type="text" class="form-control">
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input value="{{ $mannequin->height }}" id="height" name="height" type="number" class="form-control">
                                        @error('height')
                                        <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input value="{{ $mannequin->waist }}" id="waist" name="waist" type="number" class="form-control">
                                        @error('waist')
                                        <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input value="{{ $mannequin->bust }}" id="bust" name="bust" type="number" class="form-control">
                                        @error('bust')
                                        <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input value="{{ $mannequin->hips }}" id="hips" name="hips" type="number" class="form-control">
                                        @error('hips')
                                        <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input value="{{ $mannequin->hair_color }}" id="hair" name="hair_color" type="text" class="form-control">
                                        @error('hair_color')
                                        <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input value="{{ $mannequin->eyes_color }}" id="eye" name="eyes_color" type="text" class="form-control">
                                        @error('eyes_color')
                                        <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input value="{{ $mannequin->shoe_size }}" id="shoe" name="shoe_size" type="number" class="form-control">
                                        @error('shoe_size')
                                        <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
